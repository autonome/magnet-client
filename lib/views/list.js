...
class ListView extends React.Component {
  ...
  renderMessage() {
    ...
    var date = new Date(), m = date.getMonth(), d = date.getDate();
    var text = '';
    ...
    // before mozfest
    else if (m < 9 || (m == 9 && d < 28)) {
      text = 'You are too early, Mozfest has not started yet!';
    }
    // scan finished, dates are right, but nothing found.
    // you must be on the train on the way...
    else {
      text = 'Nothing found. Are you actually at Ravensbourne for Mozfest yet??!';
    }
